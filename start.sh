...
# ---------------------------------------------------------------------------
# 6. Check Node.js version (pnpm requires Node >= 18)
# ---------------------------------------------------------------------------
...
if [ "$NODE_MAJOR" -lt 18 ]; then
    ...
    echo ""
    echo "To upgrade, choose one of:"
    echo "  Homebrew:  brew install node"
    echo "  nvm:       nvm install 20 && nvm use 20"
    echo ""
    echo "If you use nvm, add this to your shell profile (~/.zshrc or ~/.bashrc)"
    echo "so nvm is active when you run start.sh:"
